...
func (h modifyTestHandler) Bind(bindDN, bindSimplePw string, conn net.Conn) (uint8, error) {
	if bindDN == "" && bindSimplePw == "" {
		return LDAPResultSuccess, nil
	}
	return LDAPResultInvalidCredentials, nil
}
func (h modifyTestHandler) Add(boundDN string, req AddRequest, conn net.Conn) (uint8, error) {
...
func (h modifyTestHandler) Delete(boundDN, deleteDN string, conn net.Conn) (uint8, error) {
...
func (h modifyTestHandler) Modify(boundDN string, req ModifyRequest, conn net.Conn) (uint8, error) {
...
func (h modifyTestHandler) ModifyDN(boundDN string, req ModifyDNRequest, conn net.Conn) (uint8, error) {
	return LDAPResultInsufficientAccessRights, nil
}
